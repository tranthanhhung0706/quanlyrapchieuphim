          ...
          <div class="col-lg-8">
            <div class="card">
              <div class="card-body">
                ...
                <hr>
          	     <form:form action="site/updatephim.htm" modelAttribute="phim"  method="post" > 
                     <div class="form-group"> 
                    <label for="input-1">Ma Phim</label> 
                    <form:input type="text" class="form-control" id="input-1"  path="ma_phim"/> 
                  </div>
