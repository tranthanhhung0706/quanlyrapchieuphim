          ...
          <div class="col-lg-8">
            <div class="card">
              <div class="card-body">
                ...
                <hr>
          	     <form:form action="site/updateve.htm" modelAttribute="ve"  method="post" > 
                     <div class="form-group"> 
                    <label for="input-1">Ma ve</label> 
                    <form:input type="text" class="form-control" id="input-1"  path="ma_ve"/> 
                  </div>
                    
                  <div class="form-group"> 
                    <label for="input-1">Ngay ban</label> 
                    <form:input type="text" class="form-control" id="input-1"   path="ngay_ban"/> 
                  </div>                            
                 <div class="form-group"> 
                    <label for="input-1">Gia ve</label> 
                    <form:input type="text" class="form-control" id="input-1"  path="gia_ve"/> 
                 </div>	
                 	<div class="form-group"> 
                    <label for="input-1">Khach hang</label> 
                    <form:input type="text" class="form-control" id="input-1"  path="khach_hang.ho_ten" 
						 /> 
                 </div>
                    <div class="form-group"> 
                    <label for="input-1">Suat chieu</label> 
                
                    <form:select path="suat_chieu.ma_sc" items="${suatchieusel}"
						itemLabel="gio_bat_dau_gio_ket_thuc" itemValue="ma_sc"
                 ...
                 <div class="form-group"> 
                    ...
                    <form:select path="ghe.ma_ghe" items="${ghesel}"
