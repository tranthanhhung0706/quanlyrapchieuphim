...
<body class="bg-theme bg-theme1">
 ...
 <div class="content-wrapper"> 
      <div class="container-fluid"> 
        ...
        <div class="row"> 
          <div class="col-lg-12"> 
            <button class="add-catalog"><a href="${pageContext.request.contextPath}/site/insertphim.htm">Thêm Phim</a></button> 
          </div> 
          <div class="col-lg-12"> 
            <div class="card"> 
              <div class="card-body"> 
                ...
                <div class="table-responsive">              
                  ...
                  <form:form action="site/phim.htm" method="post" modelAttribute="phim">
                    <thead> 
                      <tr> 
                        ...
                        <th scope="col">Gioi han tuoi  </th>
                        <th scope="col">Ngay cong chieu  </th>
                        <th scope="col">Ngon ngu  </th>
                        <th scope="col">Dien vien  </th>
                        <th scope="col">Quoc gia  </th>  
                        <th scope="col">Nha san xuat  </th> 
                        <th scope="col">Loai phim  </th>                 
                     </tr> 
                    </thead> 
                    <tbody> 
                  <c:forEach items="${phims}" var="p" > 
                      <tr> 
                        <td scope="row">${p.ma_phim}</td> 
                        <td>${p.ten}</td> 
        				<td>${p.thoi_luong}</td>
        				<td>${p.gioi_han_tuoi }</td>
        				<td>${p.ngay_cong_chieu }</td>
        				<td>${p.ngon_ngu }</td>
        				<td>${p.dien_vien }</td>
        				<td>${p.quoc_gia }</td>
        				<td>${p.nha_san_xuat }</td>
        				<td>${p.loai_phim.ten_loai_phim }</td> 
        				 <td> 
        				 <button class="btn btn-danger"><a href="site/phim/${p.ma_phim }.htm?linkDelete">Delete</a></button>
                          
                           <button  class="btn btn-success"><a href="site/phim/${p.ma_phim }.htm?linkEdit">Update</a></button>
                        </td> 
                     </tr> 
                    </c:forEach> 
                    </tbody>
