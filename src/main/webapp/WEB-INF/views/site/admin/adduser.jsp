          ...
          <div class="col-lg-8"> 
            <div class="card"> 
              <div class="card-body"> 
                ...
                ${message } 
                <hr> 
                <form:form action="site/insertuser.htm" modelAttribute="khach_hang"  method="post" > 
                 ...
                 <div class="form-group"> 
                    ...
                    <form:input type="text" class="form-control" id="input-1" placeholder="so dien thoai" path="so_dien_thoai"/> 
                 </div>	
                 <div class="form-group"> 
                    <label for="input-1">So cmnd</label> 
                    <form:input type="text" class="form-control" id="input-1" placeholder="so cmnd" path="so_cmnd"/> 
                 </div>	
                   <div class="form-group"> 
                    <label for="input-1">Email</label> 
                    <form:input type="text" class="form-control" id="input-1" placeholder="email" path="email"/> 
                 </div>
                   <div class="form-group"> 
                    <label for="input-1">Dia chi</label> 
                    <form:input type="text" class="form-control" id="input-1" placeholder="dia chi" path="dia_chi"/> 
                 </div>
                   <div class="form-group"> 
                    <label for="input-1">Gioi tinh</label> 
                    <form:input type="text" class="form-control" id="input-1" placeholder="gioi tinh" path="gioi_tinh"/> 
                 </div>
                   <div class="form-group"> 
                    <label for="input-1">Ngay sinh</label> 
                    <form:input type="text" class="form-control" id="input-1" placeholder="gioi tinh" path="ngay_sinh"/> 
                 </div>
