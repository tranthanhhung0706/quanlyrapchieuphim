...
<body class="bg-theme bg-theme1">
 ...
 <div class="content-wrapper"> 
      <div class="container-fluid"> 
        ...
        <div class="row"> 
          <div class="col-lg-12"> 
            <button class="add-catalog"><a href="${pageContext.request.contextPath}/site/insertad.htm">Thêm Admin</a></button> 
          </div> 
          <div class="col-lg-12"> 
            <div class="card"> 
              <div class="card-body"> 
                ...
                <div class="table-responsive">              
                  ...
                  <form:form action="site/admin.htm" method="post" modelAttribute="nhan_vien">
                    <thead> 
                      <tr> 
                    ...
                    <tbody> 
                  <c:forEach items="${nhan_viens}" var="nv"> 
                  
                      <tr> 
                        <td scope="row">${nv.ma_nv}</td> 
                        <td>${nv.ho_ten}</td> 
        				...
        				<td>${nv.dia_chi }</td>
        				<td>${nv.gioi_tinh }</td>
        				<td>${nv.vai_tro.vai_tro }</td> 
        				<c:if test="${nv.vai_tro.ma_vai_tro !=1 }">
        				 <td> 
        				 <button class="btn btn-danger"><a href="site/admin/${nv.ma_nv }.htm?linkDelete">Delete</a></button>
                          
                           <button  class="btn btn-success"><a href="site/admin/${nv.ma_nv }.htm?linkEdit">Update</a></button>
                        </td>
                        </c:if>
                         <c:if test="${nv.vai_tro.ma_vai_tro ==1 }">
        				 <td> 
