      ...
      <div class="container-fluid"> 
        ...
        <div class="row mt-3"> 
          <div class="col-lg-8"> 
            <div class="card"> 
              <div class="card-body"> 
                <div class="card-title">Thêm suat chieu</div>
                ${message } 
                <hr> 
                <form:form action="site/insertsuatchieu.htm" modelAttribute="suat_chieu"  method="post" > 
                           
                  <div class="form-group"> 
                    <label for="input-1">Gio bat dau va ket thuc</label> 
                    <form:input type="text" class="form-control" id="input-1" placeholder="Gio bat dau"  path="gio_bat_dau_gio_ket_thuc"/> 
                  </div> 
                                           
               
                 <div class="form-group"> 
                    <label for="input-1">Ngay chieu</label> 
                    <form:input type="text" class="form-control" id="input-1" placeholder="Ngay chieu" path="ngay_chieu"/> 
                 </div>	
                  <div class="form-group"> 
