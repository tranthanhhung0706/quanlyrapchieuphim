          ...
          <div class="col-lg-8">
            <div class="card">
              <div class="card-body">
                ...
                <hr>
          	     <form:form action="site/updatepc.htm" modelAttribute="phong_chieu"  method="post" > 
                     <div class="form-group"> 
                    <label for="input-1">Ma Phim</label> 
                    <form:input type="text" class="form-control" id="input-1"  path="ma_pc"/> 
                  </div>
                    
                  <div class="form-group"> 
                    <label for="input-1">Ten pc</label> 
                    <form:input type="text" class="form-control" id="input-1" placeholder="Username"  path="ten_pc"/> 
                  </div>                            
                 <div class="form-group"> 
                    <label for="input-1">So day ghe</label> 
                    <form:input type="text" class="form-control" id="input-1" placeholder="Tên Admin" path="so_day_ghe"/> 
                 </div>	
                 <div class="form-group"> 
                    <label for="input-1">So luong ghe</label> 
                    <form:input type="text" class="form-control" id="input-1" placeholder="Tên Admin" path="so_luong_ghe"/> 
                 </div>	
                   <div class="form-group"> 
                    <label for="input-1">Mo ta</label> 
                    <form:input type="text" class="form-control" id="input-1" placeholder="Tên Admin" path="mo_ta"/> 
                 </div>
                   
                <div class="form-group"> 
                    <label for="input-1">Rap</label> 
                
                    <form:select path="rap.ma_rap" items="${rapsel}"
						itemLabel="ten_rap" itemValue="ma_rap"
