      ...
      <div class="container-fluid">
        ...
        <div class="row mt-3">
          <div class="col-lg-8">
            <div class="card">
              <div class="card-body">
                <div class="card-title">Them phim</div>
                ${message } 
                <hr>
          	     <form:form action="site/insertphim.htm" modelAttribute="phim"  method="post" > 
                    
                  <div class="form-group"> 
                    <label for="input-1">Ten</label> 
                    <form:input type="text" class="form-control" id="input-1" placeholder="Username"  path="ten"/> 
                  </div>                            
                 <div class="form-group"> 
                    <label for="input-1">Thoi luong</label> 
                    <form:input type="text" class="form-control" id="input-1" placeholder="Tên Admin" path="thoi_luong"/> 
                 </div>	
                 <div class="form-group"> 
                    <label for="input-1">Gioi han tuoi</label> 
                    <form:input type="text" class="form-control" id="input-1" placeholder="Tên Admin" path="gioi_han_tuoi"/> 
                 </div>	
                   <div class="form-group"> 
                    <label for="input-1">Ngay cong chieu</label> 
                    <form:input type="text" class="form-control" id="input-1" placeholder="Tên Admin" path="ngay_cong_chieu"/> 
                 </div>
                   <div class="form-group"> 
                    <label for="input-1">Ngon ngu</label> 
                    <form:input type="text" class="form-control" id="input-1" placeholder="Tên Admin" path="ngon_ngu"/> 
                 </div>
                   <div class="form-group"> 
                    <label for="input-1">Dien vien</label> 
                    <form:input type="text" class="form-control" id="input-1" placeholder="Tên Admin" path="dien_vien"/> 
                 </div>
                  <div class="form-group"> 
                    <label for="input-1">Quoc gia</label> 
                    <form:input type="text" class="form-control" id="input-1" placeholder="Tên Admin" path="quoc_gia"/> 
                 </div>
                  <div class="form-group"> 
                    <label for="input-1">Nha san xuat</label> 
                    <form:input type="text" class="form-control" id="input-1" placeholder="Tên Admin" path="nha_san_xuat"/> 
                 </div>
                 <div class="form-group"> 
                    <label for="input-1">Tom tat</label> 
                    <form:input type="text" class="form-control" id="input-1" placeholder="Tên Admin" path="tom_tat"/> 
                 </div>
                 <div class="form-group"> 
                    <label for="input-1">Loai phim</label> 
                
                    <form:select path="loai_phim.ma_loai_phim" items="${loaiphimsel}"
						itemLabel="ten_loai_phim" itemValue="ma_loai_phim"
                  ...
                  <div class="form-footer"> 
                    ...
                    <button type="submit"  class="btn btn-success"><i class="fa fa-check-square-o"></i> Them</button>
                </div>  
                </form:form> 
