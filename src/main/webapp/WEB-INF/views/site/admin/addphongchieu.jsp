      ...
      <div class="container-fluid"> 
        ...
        <div class="row mt-3"> 
          <div class="col-lg-8"> 
            <div class="card"> 
              <div class="card-body"> 
                <div class="card-title">Thêm Phong chieu</div>
                ${message } 
                <hr> 
                <form:form action="site/insertphongchieu.htm" modelAttribute="phong_chieu"  method="post" > 
                           
                  <div class="form-group"> 
                    <label for="input-1">Ten phong chieu</label> 
                    <form:input type="text" class="form-control" id="input-1" placeholder="Phong chieu"  path="ten_pc"/> 
                  </div> 
                                           
                 <div class="form-group"> 
                    <label for="input-1">So day ghe</label> 
                    <form:input type="text" class="form-control" id="input-1" placeholder="so day ghe" path="so_day_ghe"/> 
                 </div>	
                 <div class="form-group"> 
                    <label for="input-1">So luong ghe</label> 
                    <form:input type="text" class="form-control" id="input-1" placeholder="so cmnd" path="so_luong_ghe"/> 
                 </div>	
                   
                   <div class="form-group"> 
                    <label for="input-1">Mo ta</label> 
                    <form:input type="text" class="form-control" id="input-1" placeholder="gioi tinh" path="mo_ta"/> 
                 </div>
