      ...
      <div class="container-fluid"> 
        ...
        <div class="row mt-3"> 
          <div class="col-lg-8"> 
            <div class="card"> 
              <div class="card-body"> 
                <div class="card-title">Thêm Ve</div>
                ${message } 
                <hr> 
                <form:form action="site/insertve.htm" modelAttribute="ve"  method="post" > 
                            
                                           
                 <div class="form-group"> 
                    <label for="input-1">Ngay ban</label> 
                    <form:input type="text" class="form-control" id="input-1" placeholder="Gio Ket thuc" path="ngay_ban"/> 
                 </div>	
                 <div class="form-group"> 
