				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav ml-auto">
						<li class="nav-item active">
							<a class="nav-link" href="${pageContext.request.contextPath}/site/index.htm">Home</a>
						</li>
						<li class="nav-item">
					...
					<div class="search-right">
						<a href="#search" class="btn search-hny mr-lg-3 mt-lg-0 mt-4" title="search">Search</a>
						<!-- search popup -->
					...
					<div class="Login_SignUp" id="login"
						...
						<!-- <li class="nav-item"> -->
							<c:if test="${khach_hangs.ho_ten == null}">
                               <a class="nav-link" href="site/sign_in.htm"><span><i class="fa fa-user-circle-o"></i></span>	</a>
                        </c:if>
						<!-- </li> -->
					</div>
					<div>
					   <c:if test="${khach_hangs.ho_ten != null}">
                                <li>
                                    <a href="site/edit_profile.htm"><strong>Chào</strong>${khach_hangs.ho_ten }</a>
                                </li>
                                <li class="hidden-xs"><a href="site/redirect.htm">Đăng xuất</a></li>
                    </c:if>
					</div>
				</div>
				...
				<div class="owl-four owl-carousel owl-theme">
					<div class="item vhny-grid">
						<div class="box16">
							<a href="#">
								<figure>
									<img class="img-fluid" src="<c:url value='/resource/assets/images/banner1.jpg'/>" alt="">
								</figure>
						...
						<div class="box16 mt-4">
							<a href="#">
								<figure>
									<img class="img-fluid" src="<c:url value='/resource/assets/images/banner2.jpg'/>" alt="">
								</figure>
								<div class="box-content">
					...
					<div class="item vhny-grid">
						<div class="box16">
							<a href="#">
								<figure>
									<img class="img-fluid" src="<c:url value='/resource/assets/images/banner3.jpg'/>" alt="">
								</figure>
								<div class="box-content">
						...
						<div class="box16 mt-4">
							<a href="#">
								<figure>
									<img class="img-fluid" src="<c:url value='/resource/assets/images/banner4.jpg'/>" alt="">
								</figure>
								<div class="box-content">
	...
	<section class="w3l-grids">
		<div class="grids-main py-5">
			<div class="container py-lg-4">
				...
				<form:form action="site/suat_chieus.htm" method="post" modelAttribute="suat_chieus">
				<div class="w3l-populohny-grids">
				<c:forEach items="${phims}" var="p">
				     <div class="item vhny-grid">
							<figure>
								<img class="img-fluid" src="<c:url value='/resource/assets/images/commando3.png'/>" alt="">
												<button  class="btn btn-success"><a href="site/suat_chieus/${p.ma_phim }.htm?linkEdit">Mua</a></button>
							</figure>
							<div>
							 <a href=".Commando3" data-toggle="modal">
								<div class="box-content">
									<h3 class="title">${p.ten }</h3>
									<h4> <span class="post"><span class="fa fa-clock-o"> </span> ${p.thoi_luong}
										</span>
										<span class="post fa fa-heart text-right"> ${p.loai_phim.ten_loai_phim }</span>
									</h4>
								</div>
							 </a>
							</div>
				...
				<div class="w3l-populohny-grids">
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<figure>
								<img class="img-fluid" src="<c:url value='/resource/assets/images/m1.jpg'/>" alt="">
							</figure>
									...
									<div class="modal-content" id="mymodalcontent">
										...
										<div class="bookbtn">
											...
											<button type="button" class="btn btn-success"
												onclick="location.href='site/ticket_booking.htm';">Book</button>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<figure>
								<img class="img-fluid" src="<c:url value='/resource/assets/images/m2.jpg'/>" alt="">
							</figure>
							...
							<div class="modal fade Doctorsleep" id="myModal" tabindex="-1" role="dialog"
								...
								<div class="modal-dialog" role="document">
									<div class="modal-content" id="mymodalcontent">
										...
										<div class="modal-body" id="dynamic-content">
											<img src="<c:url value='/resource/assets/images/m2.jpg'/>" class="img-fluid modalimg" alt="" />
											<p>
					...
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<figure>
								<img class="img-fluid" src="<c:url value='/resource/assets/images/ks1.png'/>" alt="">
							</figure>
							...
							<div class="modal fade kabir" id="myModal" tabindex="-1" role="dialog" aria-hidden="true">
								<div class="modal-dialog" role="document">
									<div class="modal-content" id="mymodalcontent">
										...
										<div class="modal-body" id="dynamic-content">
											<img src="<c:url value='/resource/assets/images/ks1.png'/>" class="img-fluid modalimg" alt="" />
											<p>
					...
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<figure>
								<img class="img-fluid" src="<c:url value='/resource/assets/images/m9.jpg'/>" alt="">
							</figure>
							...
							<div class="modal fade Joker" id="myModal" tabindex="-1" role="dialog" aria-hidden="true">
								<div class="modal-dialog" role="document">
									<div class="modal-content" id="mymodalcontent">
										...
										<div class="modal-body" id="dynamic-content">
											<img src="<c:url value='/resource/assets/images/m9.jpg'/>" class="img-fluid modalimg" alt="" />
											<p>
				...
				<div class="w3l-populohny-grids">
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<figure>
								<img class="img-fluid" src="<c:url value='/resource/assets/images/tzp.png'/>" alt="">
							</figure>
							...
							<div class="modal fade tzp" id="myModal" tabindex="-1" role="dialog" aria-hidden="true">
								<div class="modal-dialog" role="document">
									<div class="modal-content" id="mymodalcontent">
										...
										<div class="modal-body" id="dynamic-content">
											<img src="<c:url value='/resource/assets/images/tzp.png'/>" class="img-fluid modalimg" alt="" />
											<p>
					...
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<figure>
								<img class="img-fluid" src="<c:url value='/resource/assets/images/cp.png'/>" alt="">
							</figure>
							...
							<div class="modal fade Chillarparty" id="myModal" tabindex="-1" role="dialog"
								...
								<div class="modal-dialog" role="document">
									<div class="modal-content" id="mymodalcontent">
										...
										<div class="modal-body" id="dynamic-content">
											<img src="<c:url value='/resource/assets/images/cp.png'/>" class="img-fluid modalimg" alt="" />
											<p>
					...
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<figure>
								<img class="img-fluid" src="<c:url value='/resource/assets/images/ganesha.png'/>" alt="">
							</figure>
							...
							<div class="modal fade ganesha" id="myModal" tabindex="-1" role="dialog" aria-hidden="true">
								<div class="modal-dialog" role="document">
									<div class="modal-content" id="mymodalcontent">
										...
										<div class="modal-body" id="dynamic-content">
											<img src="<c:url value='/resource/assets/images/ganesha.png'/>" class="img-fluid modalimg" alt="" />
											<p>
					...
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<figure>
								<img class="img-fluid" src="<c:url value='/resource/assets/images/m8.jpg'/>" alt="">
							</figure>
							...
							<div class="modal fade Toystory" id="myModal" tabindex="-1" role="dialog"
								...
								<div class="modal-dialog" role="document">
									<div class="modal-content" id="mymodalcontent">
										...
										<div class="modal-body" id="dynamic-content">
											<img src="<c:url value='/resource/assets/images/m8.jpg'/>" class="img-fluid modalimg" alt="" />
											<p>
				...
				<div class="w3l-populohny-grids">
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<figure>
								<img class="img-fluid" src="<c:url value='/resource/assets/images/gk.png'/>" alt="">
							</figure>
							...
							<div class="modal fade gk" id="myModal" tabindex="-1" role="dialog" aria-hidden="true">
								<div class="modal-dialog" role="document">
									<div class="modal-content" id="mymodalcontent">
										...
										<div class="modal-body" id="dynamic-content">
											<img src="<c:url value='/resource/assets/images/gk.png'/>" class="img-fluid modalimg" alt="" />
											<p>
					...
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<figure>
								<img class="img-fluid" src="<c:url value='/resource/assets/images/gujjubhai.jpeg'/>" alt="">
							</figure>
							...
							<div class="modal fade gujjubhai" id="myModal" tabindex="-1" role="dialog"
								...
								<div class="modal-dialog" role="document">
									<div class="modal-content" id="mymodalcontent">
										...
										<div class="modal-body" id="dynamic-content">
											<img src="<c:url value='/resource/assets/images/gujjubhai.jpeg'/>" class="img-fluid modalimg" alt="" />
											<p>
					...
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<figure>
								<img class="img-fluid" src="<c:url value='/resource/assets/images/Thaijase.png'/>" alt="">
							</figure>
							...
							<div class="modal fade thaijase" id="myModal" tabindex="-1" role="dialog"
								...
								<div class="modal-dialog" role="document">
									<div class="modal-content" id="mymodalcontent">
										...
										<div class="modal-body" id="dynamic-content">
											<img src="<c:url value='/resource/assets/images/Thaijase.png'/>" class="img-fluid modalimg" alt="" />
											<p>
					...
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<figure>
								<img class="img-fluid" src="<c:url value='/resource/assets/images/reva.png'/>" alt="">
							</figure>
							...
							<div class="modal fade Reva" id="myModal" tabindex="-1" role="dialog" aria-hidden="true">
								<div class="modal-dialog" role="document">
									<div class="modal-content" id="mymodalcontent">
										...
										<div class="modal-body" id="dynamic-content">
											<img src="<c:url value='/resource/assets/images/reva.png'/>" class="img-fluid modalimg" alt="" />
											<p>
							...
							<div class="albums-content">
								<div class="row">
										...
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.html">
													...
													<img src="<c:url value='/resource/assets/images/m6.jpg'/>" class="img-fluid"
														alt="author image">
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.html"><img src="<c:url value='/resource/assets/images/m5.jpg'/>" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.html"><img src="<c:url value='/resource/assets/images/m4.jpg'/>" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.html"><img src="<c:url value='/resource/assets/images/m1.jpg'/>" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.html"><img src="<c:url value='/resource/assets/images/m2.jpg'/>" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.html"><img src="<c:url value='/resource/assets/images/m3.jpg'/>" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
											...
											<div class="message">
												...
												<h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr 4min
													...
													<span class="post fa fa-heart Knives Outext-right"></span>
												</h4>
											</div>
										</div>
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.html"><img src="<c:url value='/resource/assets/images/n1.jpg'/>" class="img-fluid"
														alt="author image">
													<span class="fa fa-play video-icon" aria-hidden="true"></span>
												</a>
											</div>
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.html"><img src="<c:url value='/resource/assets/images/n2.jpg'/>" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.html"><img src="<c:url value='/resource/assets/images/n3.jpg'/>" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
							...
							<div class="albums-content">
								<div class="row">
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.html"><img src="<c:url value='/resource/assets/images/m7.jpg'/>" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.html"><img src="<c:url value='/resource/assets/images/m8.jpg'/>" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.html"><img src="<c:url value='/resource/assets/images/m9.jpg'/>" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
							...
							<div class="albums-content">
								<div class="row">
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.html"><img src="<c:url value='/resource/assets/images/m10.jpg'/>" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.html"><img src="<c:url value='/resource/assets/images/m11.jpg'/>" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.html"><img src="<c:url value='/resource/assets/images/m12.jpg'/>" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
...
<script src="<c:url value='/resource/assets/js/easyResponsiveTabs.js'/>"></script>
