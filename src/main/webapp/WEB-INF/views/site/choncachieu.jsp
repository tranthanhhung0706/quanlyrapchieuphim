		...
		<nav class="navbar navbar-expand-lg navbar-light fill px-lg-0 py-0 px-3">
			<div class="container">
				...
				<div class="Login_SignUp" id="login_s">
					...
					<!-- <li class="nav-item"> -->
					<a class="nav-link" href="site/sign_in.htm"><i class="fa fa-user-circle-o"></i></a>
					<!-- </li> -->
				</div>
...
<div class="col-4" style="margin-top: 50px;">
         <form:form action="site/movies3.htm" modelAttribute="suat_chieus"  method="post" > 
   <div class="form-group">
   <label for="input-1">Ca chieu</label> 
   <form:select path="gio_bat_dau_gio_ket_thuc" 
						class="form-select" aria-label="Default select example" style="width: 200px;" >
						<c:forEach var="a" items="${suatchieus3 }">
                           <option value="${a[0]}"> 
                          ${a[0]}
                        </option>
         </c:forEach>
